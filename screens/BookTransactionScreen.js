...
export default class TransactionScreen extends React.Component {
    ...
    checkStudentEligibilityForReturn = async()=>{
      ...
      var isStudentEligible1 = ""
      transactionRef.docs.map((doc)=>{
        var lastBookTransaction = doc.data();
        if(lastBookTransaction.studentId === this.state.scannedStudentId)
          isStudentEligible1 = true
        else {
          isStudentEligible1 = false
    ...
    handleTransaction = async()=>{
     //verify if the student is eligible for book issue or return or none
      ...
      if (!transactionType) {
        ...
        var isStudentEligible2 = await this.checkStudentEligibilityForReturn()
